...
public class CalculadoraServer {
    ...
    public static void main(String[] args) {
        if (args != null && args.length < 3) {
            System.err.println("usage: java [options] edu.ufp.sd.calculadora.server.CalculadoraServer <rmi_registry_ip> <rmi_registry_port> <service_name>");
            System.exit(-1);
        } else {
            //1. ============ Create Servant ============
            CalculadoraServer hws = new CalculadoraServer(args);
    ...
    private void rebindService() {
        try {
            ...
            if (registry != null) {
                //============ Create Servant ============
                helloWorldRI= new CalculadoraImpl();
